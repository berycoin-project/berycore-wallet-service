 ...
 * @param {string} opts.coin[='bery'] - The coin for this wallet (bery, bch).
 ...
 * @param {string} opts.coin[='bery'] - The expected coin for this wallet (bery, bch).
...
WalletService.prototype.savePreferences = function(opts, cb) {
  ...
  var preferences = [{
    ...
    name: 'unit',
    isValid: function(value) {
      return _.isString(value) && _.contains(['bery', 'bit'], value.toLowerCase());
    },
  }];
 ...
 * @param {Object} opts
 * @param {String} [opts.coin='bery'] (optional)
 ...
 * @param {Object} opts
 * @param {string} [opts.coin = 'bery'] - The coin to estimate fee levels from.
 ...
 * @param {Object} opts
 * @param {string} [opts.coin = 'bery'] - The coin for this transaction.
